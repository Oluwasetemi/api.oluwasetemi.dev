...
const apiRoutes = {
  ...
  comments: [
    {
      ...
      actions: ["middleware", "list"],
      docsUrl: "https://api.oluwasetemi.dev/reference#main-api/tag/comments/GET/posts/{postId}/comments",
    },
    {
      method: "POST",
      path: "/posts/:postId/comments",
      actions: ["middleware", "create"],
      docsUrl: "https://api.oluwasetemi.dev/reference#main-api/tag/comments/POST/posts/{postId}/comments",
    },
    {
      method: "GET",
      path: "/comments/:id",
      actions: ["middleware", "getOne"],
      docsUrl: "https://api.oluwasetemi.dev/reference#main-api/tag/comments/GET/comments/{id}",
    },
    {
      method: "PATCH",
      path: "/comments/:id",
      actions: ["middleware", "middleware", "patch"],
      docsUrl: "https://api.oluwasetemi.dev/reference#main-api/tag/comments/PATCH/comments/{id}",
    },
    {
      method: "DELETE",
      path: "/comments/:id",
      actions: ["middleware", "remove"],
      docsUrl: "https://api.oluwasetemi.dev/reference#main-api/tag/comments/DELETE/comments/{id}",
    },
  ],
  auth: [
    {
  ...
  sse: [
    ...
    },
    {
      method: "GET",
      path: "/sse/comments",
      actions: ["commentsStream"],
      docsUrl: "https://api.oluwasetemi.dev/reference#main-api/tag/sse/GET/sse/comments",
    },
    {
      method: "GET",
      path: "/sse/client",
...
function getRouteDescription(path: string, method: string): string {
  const descriptions: Record<string, string> = {
    ...
    "GET /sse/comments": "Server-Sent Events for comment updates",
          ...
          {Object.entries(apiRoutes).map(([category, routes]) => {
            ...
            const categoryMeta: Record<string, { icon: string; title: string; description: string }> = {
              ...
              comments: {
                icon: "",
                title: "Comments API",
                description: "Comment system for posts with anonymous and authenticated support, ownership controls",
              },
              auth: {
                icon: "",
