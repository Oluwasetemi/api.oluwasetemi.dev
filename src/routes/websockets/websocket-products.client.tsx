...
const WebSocketProductsClient: FC = () => {
  const styles = `
          * {
  ...
  return (
    <Layout
      title="WebSocket Test Client - Products"
      styles={styles}
    >
      <h1>WebSocket Test Client - Products Channel</h1>
      ...
      <script
        ...
        function addMessage(type, content) {
            ...
            contentEl.textContent = typeof content === 'object'
            ...
            if (type === 'received') {
                ...
                document.getElementById('msgReceived').textContent = messageCount.received;
            } else if (type === 'sent') {
                messageCount.sent++;
        ...
        function sendMessage(message) {
            ...
            addMessage('error', 'Cannot send message: WebSocket not connected');
            return false;
        }
        ...
        function subscribeToProduct() {
            ...
            if (!productId) {
                addMessage('error', 'Please enter a product ID');
                return;
            }
            sendMessage({
                type: 'subscribe',
        ...
        window.addEventListener('load', () => {
            addMessage('system', 'WebSocket test client loaded. Click "Connect" to start.');
        });
...
// Route handler
app.get("/ws/client/products", (c) => {
  return c.html(<WebSocketProductsClient />);
});
