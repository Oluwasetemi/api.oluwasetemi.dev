...
const WebSocketTestClient: FC = () => {
  ...
  return (
    <Layout
      title="WebSocket Test Client - Tasks"
      styles={styles}
    >
      <h1>WebSocket Test Client - Tasks Channel</h1>
      ...
      <script
        ...
        function subscribeToTask() {
            ...
            if (!taskId) {
                addMessage('error', 'Please enter a task ID');
                return;
            }
            sendMessage({
                type: 'subscribe',
...
// Route handler
app.get("/ws/client/tasks", (c) => {
  return c.html(<WebSocketTestClient />);
});
