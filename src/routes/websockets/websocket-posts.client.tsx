...
const WebSocketPostsClient: FC = () => {
  ...
  return (
    <Layout
      title="WebSocket Test Client - Posts"
      styles={styles}
    >
      <h1>WebSocket Test Client - Posts Channel</h1>
      ...
      <script
        ...
        function subscribeToPost() {
            ...
            if (!postId) {
                addMessage('error', 'Please enter a post ID');
                return;
            }
            sendMessage({
                type: 'subscribe',
...
// Route handler
app.get("/ws/client/posts", (c) => {
  return c.html(<WebSocketPostsClient />);
});
