...
const defaultOptions: SecurityHeadersOptions = {
  ...
  contentSecurityPolicy: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://apollo-server-landing-page.cdn.apollographql.com https://embeddable-explorer.cdn.apollographql.com https://embeddable-sandbox.cdn.apollographql.com; script-src-elem 'self' 'unsafe-inline' https://apollo-server-landing-page.cdn.apollographql.com https://embeddable-explorer.cdn.apollographql.com https://embeddable-sandbox.cdn.apollographql.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https: https://apollo-server-landing-page.cdn.apollographql.com; font-src 'self'; connect-src 'self' https: https://apollo-server-landing-page.cdn.apollographql.com https://embeddable-explorer.cdn.apollographql.com; frame-src 'self' https://sandbox.embed.apollographql.com https://embeddable-sandbox.netlify.app; manifest-src 'self' https://apollo-server-landing-page.cdn.apollographql.com; frame-ancestors 'none';",
