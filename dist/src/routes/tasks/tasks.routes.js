...
import { insertTasksSchema, patchTasksSchema, PriorityEnum, selectTasksSchema, StatusEnum } from "../../db/schema.js";
...
export const list = createRoute({
    ...
    responses: {
        ...
        }).or(z.array(selectTasksSchema)), "List of tasks"),
...
export const listChildren = createRoute({
    ...
    responses: {
        ...
        }).or(z.array(selectTasksSchema)), "List of children tasks"),
    },
});
...
export const patch = createRoute({
    ...
    responses: {
        ...
        [HttpStatusCodes.NOT_FOUND]: jsonContent(notFoundSchema, "Task not found"),
        [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(createErrorSchema(patchTasksSchema).or(createErrorSchema(IdUUIDParamsSchema)), "The validation error(s)"),
    },
});
